  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950">
      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white">DreamOracle</span>
          </Link>
          {session ? (
            <Link
              href="/dashboard"
      ...
      <main className="container mx-auto px-4 py-12">
        {/* Canceled banner */}
        {canceled && (
          <div className="max-w-2xl mx-auto mb-8 p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg text-amber-200 text-center">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="text-center py-4 px-4 text-amber-400 font-medium">
                    Oracle
                  </th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-slate-800">
                  <td className="py-4 px-4 text-slate-300">Rêves par mois</td>
                  <td className="text-center py-4 px-4 text-slate-400">5</td>
                  <td className="text-center py-4 px-4 text-white">Illimité</td>
                  <td className="text-center py-4 px-4 text-white">Illimité</td>
                </tr>
                <tr className="border-b border-slate-800">
                  ...
                  <td className="text-center py-4 px-4 text-slate-400">2</td>
                ...
                <tr className="border-b border-slate-800">
                  ...
                  <td className="text-center py-4 px-4 text-white">10/mois</td>
                  <td className="text-center py-4 px-4 text-white">Illimité</td>
                </tr>
                <tr className="border-b border-slate-800">
                  <td className="py-4 px-4 text-slate-300">Export PDF</td>
                  <td className="text-center py-4 px-4">
                    <X className="h-5 w-5 text-slate-600 mx-auto" />
                  </td>
                  <td className="text-center py-4 px-4 text-white">5/mois</td>
                  <td className="text-center py-4 px-4 text-white">Illimité</td>
                </tr>
                <tr className="border-b border-slate-800">
                  <td className="py-4 px-4 text-slate-300">Calendrier</td>
                  <td className="text-center py-4 px-4">
                ...
                <tr className="border-b border-slate-800">
                  <td className="py-4 px-4 text-slate-300">Notifications</td>
                  <td className="text-center py-4 px-4">
                    <X className="h-5 w-5 text-slate-600 mx-auto" />
                  </td>
                  <td className="text-center py-4 px-4">
                ...
                <tr className="border-b border-slate-800">
                  <td className="py-4 px-4 text-slate-300">Analyse patterns</td>
                  <td className="text-center py-4 px-4">
                    <X className="h-5 w-5 text-slate-600 mx-auto" />
                  </td>
                  <td className="text-center py-4 px-4">
                ...
                <tr className="border-b border-slate-800">
                  <td className="py-4 px-4 text-slate-300">Support prioritaire</td>
                  <td className="text-center py-4 px-4">
                    <X className="h-5 w-5 text-slate-600 mx-auto" />
                  </td>
                  <td className="text-center py-4 px-4">
